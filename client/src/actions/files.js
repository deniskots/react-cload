...
//в параметры передаем айди дериктории в которой находимся,
//из функции возр функцию с параметром диспатч
export function getFiles(dirId, sort) {
    return async dispatch => {
        try {
            ...
            //если находимся в корневой папке айди пустой,если айди пустой то добавляем пустую строку,иначе добав.параметр
        ...
        try {
            ...
            const response = await axios.post(`http://localhost:5000/api/files/upload`, formData, {
                ...
                onUploadProgress: progressEvent => {
                    ...
                    //процент загрузки(loaded-показывает размер загруженных байт,умножаем и потом делилим на общую сумму)
                    if (totalLength) {
